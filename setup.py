# This setup.py is used to build the py_qwen3_tts_cpp package.
# The environment variables you may find interesting are:
#
# PY_QWEN3_TTS_CPP_VERSION
...
class CMakeBuild(build_ext):
    def build_extension(self, ext: CMakeExtension) -> None:
        ...
        dll_folder = os.path.join(self.build_temp, "_py_qwen3_tts_cpp", "bin", cfg)
...
class RepairWheel(bdist_wheel):
    ...
    def repair_wheel(self):
        global dll_folder
        if dll_folder == "unset" or not Path(dll_folder).exists():
            print("dll_folder is unset")
            return
...
def get_version() -> str:
    try:
        return os.environ["PY_QWEN3_TTS_CPP_VERSION"]
    except KeyError:
        pass
...
setup(
    name="py-qwen3-tts-cpp",
    author="femelo",
    description="Python bindings for qwen3-tts.cpp",
    long_description=long_description,
    ext_modules=[CMakeExtension("py_qwen3_tts_cpp._py_qwen3_tts_cpp", sourcedir=".")],
    cmdclass={
    ...
    entry_points={
        "console_scripts": [
            ...
            "pqw3tts-playback=py_qwen3_tts_cpp.examples.playback:_main",
        ]
    },
    project_urls={
        "Source": "https://github.com/femelo/py-qwen3-tts-cpp",
        "Tracker": "https://github.com/femelo/py-qwen3-tts-cpp/issues",
    },
    install_requires=["numpy", "requests", "tqdm", "platformdirs"],
    extras_require={"examples": ["sounddevice"]},
)
